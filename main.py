...
# Initialize Database Schema once using st.cache_resource
...
<span style="font-size: 0.76rem; color: #475569 !important; font-weight: 600;">AI Interviewer & Coach</span>
        ...
        if engine and engine.current_question:
            if st.button("💬 Active Interview", use_container_width=True, type="secondary" if current_page != "interview" else "primary"):
        ...
        st.markdown(
            f"""<div style="font-size: 0.78rem; color: #334155 !important; line-height: 1.5; font-weight: 500;">
