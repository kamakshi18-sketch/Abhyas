...
def render_interview_page() -> None:
    ...
    st.markdown(
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; flex-wrap: wrap; gap: 0.5rem;">
            <div>
                <h3 style="margin: 0; font-size: 1.4rem; color: #f8fafc;">🎙️ Live Interview Session</h3>
    ...
    st.markdown(
        f"""
        <div style="background: rgba(30, 41, 59, 0.85); border: 1px solid rgba(59, 130, 246, 0.4); border-left: 5px solid #3b82f6; border-radius: 10px; padding: 1.35rem 1.6rem; margin-bottom: 1.25rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.2);">
    ...
    if not has_submitted:
        answer_text = st.text_area(
            ...
            key=input_key,
            height=180,
            placeholder="Type your response here. Articulate your thought process, architectural choices, or structured STAR response...",
            help="Be thorough and specific. AI evaluation will assess relevance, correctness, completeness, clarity, and depth.",
        )
        ...
        with btn_col3:
            if st.button("⏹️ End Interview", use_container_width=True, help="Conclude early and view results"):
