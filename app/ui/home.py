...
<h1 style="font-size: 2.8rem; margin-bottom: 0.5rem; font-weight: 800; letter-spacing: -0.02em; color: #f8fafc;">
🎯 Abhyas — AI Interviewer & Coach
</h1>
<p style="font-size: 1.15rem; color: #94a3b8; max-width: 650px; margin: 0 auto; line-height: 1.6;">
Intelligent, rubric-driven interview preparation powered by <b style="color: #38bdf8;">Google Gemini</b>, <b style="color: #38bdf8;">NVIDIA Nemotron</b>, and <b style="color: #38bdf8;">Local Ollama</b>.
Practice realistic technical, behavioral STAR, and HR sessions with grounded, actionable feedback.
    ...
    with status_col2:
        ...
        st.markdown(
            f"""<div style="background: rgba(30, 41, 59, 0.7); padding: 1.1rem; border-radius: 10px; border: 1px solid rgba(255, 255, 255, 0.12); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.2);">
